...
const PHONE_NUMBER = import.meta.env.VITE_PHONE_NUMBER || "+92 300 1234567";
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 border-b transition-all duration-300 ${
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-2">
          <Link to="/" className="flex items-center gap-1.5 flex-shrink-0 transition-all duration-300 hover:opacity-80">
          ...
          <div className="flex items-center gap-2">
            <Link to="/login" className="hidden sm:inline text-xs font-black uppercase tracking-[0.14em] text-foreground transition-all duration-300 hover:text-[#c4975a] hover:-translate-y-0.5">Login</Link>
            <Link to="/bookings" className="bg-[#c4975a] px-4 py-2 text-xs font-black uppercase tracking-[0.12em] text-white shadow-md shadow-[#c4975a]/25 transition-all duration-300 hover:scale-105 hover:bg-[#b8894d] hover:shadow-lg hover:shadow-[#c4975a]/40 active:scale-95">Book Event</Link>
              ...
              <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
                ...
                <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
                  {weddingMoments.map((moment, i) => (
                    ...
                    >
                      <Link to="/bookings?category=event-timeline"
          ...
          <section id="categories" className="bg-[#fcf6ed] py-20">
            <div className="mx-auto max-w-7xl px-4">
              ...
              <div className="mt-10 text-center">
                <Link to="/dashboard" className="inline-flex items-center gap-2 text-sm font-black uppercase tracking-[0.16em] text-[#c4975a] transition-all duration-300 hover:text-[#d4af37] hover:-translate-y-0.5 hover:gap-3">
          ...
          <section id="contact" className="bg-[#4a3528] py-20 text-white">
            <div className="mx-auto grid max-w-7xl gap-10 px-4 lg:grid-cols-[1fr_0.9fr] lg:items-center">
              ...
              <div className="border-[2.5px] border-white/18 bg-white/8 p-6 transition-all duration-500 hover:bg-white/12 hover:shadow-2xl">
                <div className="text-xs font-black uppercase tracking-[0.2em] text-[#e8c878]">Get in Touch</div>
                <div className="mt-5 space-y-4">
                  <div className="flex items-start gap-3">
                    <Phone size={16} className="mt-0.5 shrink-0 text-[#e8c878]" />
                    <div>
                      <div className="text-xs font-bold text-white/60">Phone</div>
                      <a href={`tel:${PHONE_NUMBER}`} className="text-sm text-white hover:text-[#d4af37] transition-colors">{PHONE_NUMBER}</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <MessageCircle size={16} className="mt-0.5 shrink-0 text-[#e8c878]" />
                    <div>
                      <div className="text-xs font-bold text-white/60">WhatsApp</div>
                      <a href={`https://wa.me/${WHATSAPP_NUMBER}`} target="_blank" rel="noopener noreferrer" className="text-sm text-white hover:text-[#d4af37] transition-colors">Chat with us</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <MapPin size={16} className="mt-0.5 shrink-0 text-[#e8c878]" />
                    <div>
                  ...
                  <div className="pt-3 border-t border-white/10">
                    <Link to="/enquiry"
                      className="inline-flex items-center gap-2 border border-[#d4af37] bg-[#d4af37] px-4 py-2.5 text-xs font-black uppercase tracking-[0.12em] text-white shadow-md shadow-[#d4af37]/25 transition-all duration-300 hover:scale-[1.02] hover:bg-[#c4a030] hover:shadow-lg hover:shadow-[#d4af37]/40 active:scale-[0.98]">
                      Submit an Enquiry
                    </Link>
                  </div>
                </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                {["Wedding Planning", "Catering", "Venue Selection", "Decor & Design", "Corporate Events"].map((s) => (
                  <li key={s}>
                    <Link to="/bookings" className="text-sm text-white/60 hover:text-[#d4af37] transition-colors">{s}</Link>
                  </li>
                ))}
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2.5">
                {[
                  ...
                  <li key={s.label}>
                    <Link to={s.href} className="text-sm text-white/60 hover:text-[#d4af37] transition-colors">{s.label}</Link>
                  </li>
                ))}
              </ul>
            </div>
