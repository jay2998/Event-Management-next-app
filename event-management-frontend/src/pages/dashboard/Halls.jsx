  ...
  return (
    <main className="min-h-screen bg-[#f7f3ed] px-4 py-6 text-[#171717] sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
                        ...
                        {halls.map((hall) => {
                          ...
                          className="relative rounded-xl border-[2.5px] p-4 transition">
                              <div className="flex items-start justify-between gap-2 mb-2">
                                ...
                                <span className="inline-flex items-center gap-1 rounded-md border-[2.5px] px-2 py-0.5 text-[9px] font-black uppercase tracking-[0.1em] shrink-0">
                                  <StIcon size={10} />
        ...
        <FormDropdown show={showVenueForm} onClose={() => setShowVenueForm(false)} title={editingVenueId ? "Edit Venue" : "Add Venue"}>
        ...
        <FormDropdown show={showHallForm} onClose={() => setShowHallForm(false)} title="Add Hall">
        ...
        <FormDropdown show={showSuggestions} onClose={() => setShowSuggestions(false)} title="Alternative Halls">
