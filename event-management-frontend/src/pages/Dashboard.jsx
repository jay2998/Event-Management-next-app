    ...
    <div className="border-2 border-[#c4b096]/70 bg-[#f9f3e8] p-2.5 shadow-sm">
      ...
      {hasData ? (
        <div className="flex justify-center pt-3 overflow-x-auto">
          <BarChart data={chartData} width={Math.max(chartData.length * 110, Math.min(400, window.innerWidth - 80))} height={260} margin={{ top: 10, right: 20, bottom: 10, left: 10 }}>
        ...
        {!isCustomer ? (
          <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-[1fr_1.8fr_1.8fr_360px]">
            ...
            <div className="flex flex-col gap-3 min-h-0">
              ...
              {user.role === "admin" && (
                <Link to="/dashboard/admin/access-control" className="flex items-center gap-2 border-2 border-[#c4b096]/70 bg-gradient-to-r from-[#f0fdfa]/80 to-[#f9f3e8] p-3 shadow-sm hover:border-[#d4af37] transition shrink-0">
