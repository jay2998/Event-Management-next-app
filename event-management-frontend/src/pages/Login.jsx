...
export default function LoginPage() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      navigate(userRole === "customer" ? "/enquiry" : "/dashboard");
    } catch (err) {
      ...
      if (match) {
        ...
        return navigate(match.role === "customer" ? "/enquiry" : "/dashboard");
      }
    ...
    <main className="min-h-screen flex items-center justify-center px-4 py-12 bg-[#fcf8f2]">
      <div className="w-full max-w-sm space-y-4">
        ...
        <div className="text-center text-[11px] text-black/40">
          <Link to="/" className="transition-colors hover:text-[#c4975a]">
