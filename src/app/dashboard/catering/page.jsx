...
export default function CateringPage() {
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4" onClick={() => setShowForm(false)}>
      <div className="w-full max-w-sm rounded-2xl border-[2.5px] border-[#c4b096] bg-[#f9f3e8] p-5 shadow-2xl" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-base font-black text-[#3d2c1f]">{editingId ? "Edit Menu Item" : "Add Menu Item"}</h2>
  ...
  const renderDraftForm = () => (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4" onClick={() => setShowDraftForm(false)}>
      <div className="w-full max-w-lg rounded-2xl border-[2.5px] border-[#c4b096] bg-[#f9f3e8] p-5 shadow-2xl max-h-[85vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-base font-black text-[#3d2c1f]">
            {editingDraftId ? "Edit Draft Menu" : "New Draft Menu"}
          </h2>
          <button onClick={() => setShowDraftForm(false)} className="flex h-7 w-7 items-center justify-center rounded-full hover:bg-white/80">
            <X size={14} />
          </button>
        </div>
  ...
  const renderOrderModal = () => {
    ...
    const o = viewOrder;
    return (
      <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4" onClick={() => setViewOrder(null)}>
        <div className="w-full max-w-lg rounded-2xl border-[2.5px] border-[#c4b096] bg-[#f9f3e8] p-5 shadow-2xl" onClick={(e) => e.stopPropagation()}>
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-base font-black text-[#3d2c1f]">{o.name || "Order Details"}</h2>
            <button onClick={() => setViewOrder(null)} className="flex h-7 w-7 items-center justify-center rounded-full hover:bg-white/80">
              <X size={14} />
            </button>
          </div>
  ...
  const renderOrderForm = () => (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4" onClick={() => setShowOrderForm(false)}>
      <div className="w-full max-w-lg rounded-2xl border-[2.5px] border-[#c4b096] bg-[#f9f3e8] p-5 shadow-2xl max-h-[85vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-base font-black text-[#3d2c1f]">{editingOrderId ? "Edit Order" : "New Order"}</h2>
          <button onClick={() => setShowOrderForm(false)} className="flex h-7 w-7 items-center justify-center rounded-full hover:bg-white/80">
            <X size={14} />
          </button>
        </div>
  ...
  const renderQcForm = () => (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4" onClick={() => setShowQcForm(false)}>
      <div className="w-full max-w-sm rounded-2xl border-[2.5px] border-[#c4b096] bg-[#f9f3e8] p-5 shadow-2xl" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-base font-black text-[#3d2c1f]">Quality Check</h2>
          <button onClick={() => setShowQcForm(false)} className="flex h-7 w-7 items-center justify-center rounded-full hover:bg-white/80">
            <X size={14} />
          </button>
        </div>
