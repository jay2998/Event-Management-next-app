      ...
      <div className="w-full max-w-sm">
        <div className="bg-white p-6 shadow-2xl border border-[#e8e1d5]">
          ...
          <form onSubmit={onSubmit} className="mt-4 space-y-3">
            {error && (
              <div className="border-[2.5px] border-red-300 bg-red-50 px-4 py-3 text-xs text-red-700">{error}</div>
            )}
            ...
            <label className="block">
              <span className="flex items-center gap-2"><Lock size={14} className="text-[#b4975a]" /> Confirm Password</span>
              <input
